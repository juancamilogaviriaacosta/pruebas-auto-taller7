...
public class AgregarCargoTest {
    ...
    public void agregarCargoTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.basic_charge_fee_edit_text), withId(R.id.basic_charge_fee_edit_text), isDisplayed()));
        appCompatEditText.perform(replaceText("0.0254"), closeSoftKeyboard());
